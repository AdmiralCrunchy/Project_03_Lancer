...
const Card = styled(MuiCard)(({ theme }) => ({
  ...
  const columns = [
    {id: 'projectName', label: 'Project Name', minWidth: 170, align: 'canter'},
    {id: 'projectDeadline', label: 'Project Deadline', minWidth: 170,  align: 'center'},
       ...
       .then((data) =>{
        ...
        data.Projects.map(project => {
          let details = {
            ...
            projectDeadline: project.completion_date,
          }
